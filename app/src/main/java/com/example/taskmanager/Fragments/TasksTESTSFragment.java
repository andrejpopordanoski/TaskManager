...
public class TasksTESTSFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        taskList = currentProject.getAllTasksFromState("TEST");
...
//        });
    ...
    private void getTasksForCurrentUser (){
        mDatabaseCurrentProject.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                taskList = project.getAllTasksFromState("TEST");
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        Log.i("TEST", "onActiviry result in fragment");
        if(resultCode == Activity.RESULT_OK){
            Log.i("TEST", "onActiviry result in fragment but in OK");
...
//            getTasksForCurrentUser();
    ...
    public void onRadioButtonClicked(View view) {
        ...
        switch(view.getId()) {
            case R.id.all_tasks:
                if (checked) {
                    this.taskList = currentProject.getAllTasksFromState("TEST");
                    setAdapter();
                }
            ...
            case R.id.your_tasks:
                if (checked) {
                    this.taskList = currentProject.getAllTaksksFromStateAndCollaborator("TEST", mCurrentUser.getEmail());
                    setAdapter();
                }
                break;
        }
