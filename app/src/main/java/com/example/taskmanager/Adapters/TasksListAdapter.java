...
//        this.mContext = mContext;
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            taskName = (TextView) itemView.findViewById(R.id.meeting_item_meeting_name);
            parentLayout = (LinearLayout) itemView.findViewById(R.id.parent_layout);
            dateTextView = (TextView) itemView.findViewById(R.id.meeting_item_meeting_date);
            priorityLayout = (LinearLayout) itemView.findViewById(R.id.left_pad);
